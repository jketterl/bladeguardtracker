...
public class HttpSocketConnection {
    private static final String TAG = "HttpSocketConnection";
    ...
    private BroadcastReceiver connectivityReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG, "connectivity: " + isConnected());
        }
	...
	protected HttpSocketConnection(Context applicationContext) {
	...
	private WebSocketClient getSocket()
	{
		if (socket == null) {
			try {
				...
				socket = new WebSocketClient(url, new WebSocketHandler(), null);
